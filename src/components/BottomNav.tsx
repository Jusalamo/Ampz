...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-app h-[68px] bg-background/[0.98] backdrop-blur-xl border-t border-border/30 flex justify-around items-center pb-safe z-50">
